		...
		<footer className={style.footer}>
			<div className={style.footerLinks}>
				...
				<div className={style.social}>
					<ul>
						<li>
							<a href="https://facebook.com/yusufneeson">
								<img
						...
						<li>
							<a href="https://twitter.com/yusufneeson">
								<img
						...
						<li>
							<a href="https://www.pinterest.com/yusufneeson">
								<img
						...
						<li>
							<a href="https://instagram.com/yusufneeson">
								<img
